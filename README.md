...
Soy un desarrollador con más de 10 años de experiencia transformando problemas complejos en aplicaciones escalables y fáciles de mantener. Mi enfoque combina la robustez de **Java** con la agilidad de **Node.js y React**, siempre bajo la premisa del **Software Craftsmanship**: escribir código que no solo funcione, sino que sea un placer leer.

---

## Me define en pocas líneas:

- **Seniority Multidisciplinario:** 10 años en ecosistemas Java (17+) y 6 años evolucionando con Node.js y React.
...
| :--- | :--- | :--- |
| **Java 17/11/8** (Spring Boot 3, JPA) | **React.js** (Hooks, Redux, Context) | **AWS** (Lambda, DynamoDB, S3) |
| **Node.js** (TypeScript, Express) | **HTML5 & CSS3** (Tailwind, Sass) | **GCP** (Spanner, BigQuery) |
| **Arquitectura:** Microservicios, Hexagonal | **Testing:** JUnit 5, Mockito | **BBDD:** PostgreSQL, MongoDB, Redis |
...
- **Stack:** Java 17, GCP Cloud Functions, Integración de Modelos de IA.
